...
function fcbh_script()
{
    ...
    wp_register_script('slick-js', get_bloginfo('template_directory') . '/assets/librerias/js/slick.min.js', array('jquery'), '1', true);
    ...
    wp_enqueue_script('slick-js', array('jquery'), true);
    wp_enqueue_script('mi-js', array('jquery'), true);
    

    }
}
add_action("wp_enqueue_scripts", "fcbh_script", 1); //1 representa prioridad, mas alto el número = mas prioridad.